...
"Paintables": {
    "Stack": {
        "Order"     : ["ZDiboson","stopWtschan","W","ttbar","stoptchan"],
        "Processes" : {                
            "ZDiboson" : {
                "Color"         : "#fa7921",
                "Contributions" : ["Zee", "Zmumu", "Ztautau","WWlvlv", "WWlvqq", "WZlvll", "WZlvvv", "WZqqll", "WZlvqq", "ZZllll", "ZZvvll", "ZZqqll"]},
            ...
            "stoptchan": {
                "Color"         : "#e035da",
                "Contributions" : ["stop_tchan_top", "stop_tchan_antitop"]},

            "stopWtschan": {
                "Color"         : "#fde74c",
                "Contributions" : ["stop_schan_top", "stop_schan_antitop", "stop_wtchan_top", "stop_wtchan_antitop"]},
